...
$translations = array(
    "button" => [
        ...
        "email_explain" => erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','We will send you a transcript of your chat with agent, so you can browse it later.'),
