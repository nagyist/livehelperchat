...
<head>
    ...
    <?php if (
            (!isset($Result['theme_obj']) || !isset($Result['theme_obj']->bot_configuration_array['viewport']) || $Result['theme_obj']->bot_configuration_array['viewport'] == '' ) ||
            ($Result['theme_obj']->bot_configuration_array['viewport'] == '1' && (new Mobile_Detect())->isMobile() == true && $Result['theme_obj']->bot_configuration_array['viewport'] != '2')
    ) : ?>
...
if (
    ...
    <?php if (!isset($Result['voice_call'])) : ?>
        <script <?php isset($Result['app_scope']) ? print 'scope="' . htmlspecialchars($Result['app_scope']) . '"' : '' ?> src="<?php echo erLhcoreClassDesign::design('js/widgetv2/vendor.ie.js')?>?v=a8_<?php echo $staticVersion;?>"></script>
        <script <?php isset($Result['app_scope']) ? print 'scope="' . htmlspecialchars($Result['app_scope']) . '"' : '' ?> src="<?php echo erLhcoreClassDesign::design('js/widgetv2/react.app.ie.js')?>?t=412_<?php echo $staticVersion;?>"></script>
    <?php else : ?>
...
<?php else : ?>
    <?php if (!isset($Result['voice_call'])) : ?>
        <script <?php isset($Result['app_scope']) ? print 'scope="' . htmlspecialchars($Result['app_scope']) . '"' : '' ?> src="<?php echo erLhcoreClassDesign::design('js/widgetv2/vendor.js')?>?v=a8_<?php echo $staticVersion;?>"></script>
        <script <?php isset($Result['app_scope']) ? print 'scope="' . htmlspecialchars($Result['app_scope']) . '"' : '' ?> src="<?php echo erLhcoreClassDesign::design('js/widgetv2/react.app.js')?>?t=412_<?php echo $staticVersion;?>"></script>
        <?php else : ?>
